...
/*
IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='V' AND NAME = 'promedioDesgasteComponentePorAutoPorCircuito' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP VIEW GRUPO_9800.promedioDesgasteComponentePorAutoPorCircuito
GO
*/
...
IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_TELEMETRIA_CAJA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_TELEMETRIA_CAJA
GO

IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_TELEMETRIA_MOTOR' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_TELEMETRIA_MOTOR
GO

IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_TELEMETRIA_NEUMATICO' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_TELEMETRIA_NEUMATICO
GO

IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_TELEMETRIA_FRENO' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_TELEMETRIA_FRENO
GO

--DROP PREVENTIVO DE TABLAS DE HECHOS---------------------------------------------------------------
/*
IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_DESGASTE_VISTA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_DESGASTE_VISTA
GO
*/
IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_CIRCUITO_VISTA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_CIRCUITO_VISTA
GO

IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_INCIDENTE_VISTA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_INCIDENTE_VISTA
GO

IF EXISTS (SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='U' AND NAME = 'BI_PARADA_VISTA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
	DROP TABLE GRUPO_9800.BI_PARADA_VISTA
GO

--DROP PREVENTIVO DE PROCEDURES DE MIGRACION DE TABLAS DIMENSIONALES---------------------------------------------------------------
...
IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = 'MIGRAR_BI_telemetria_caja' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800.MIGRAR_BI_telemetria_caja
GO

IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = 'MIGRAR_BI_telemetria_motor' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800.MIGRAR_BI_telemetria_motor
GO

IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = 'MIGRAR_BI_telemetria_neumatico' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800.MIGRAR_BI_telemetria_neumatico
GO

IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = 'MIGRAR_BI_telemetria_freno' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800.MIGRAR_BI_telemetria_freno
GO
...
IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = '_VISTAS' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800._VISTAS
GO

--DROP PREVENTIVO DE PROCEDURES DE MIGRACION DE TABLAS DE HECHOS---------------------------------------------------------------

IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = 'MIGRATE_BI_INCIDENTE_VISTA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800.MIGRATE_BI_INCIDENTE_VISTA
GO

IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = 'MIGRATE_BI_CIRCUITO_VISTA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800.MIGRATE_BI_CIRCUITO_VISTA
GO

IF EXISTS(SELECT SCHEMA_NAME (SCHEMA_ID), NAME FROM SYS.objects WHERE TYPE ='P' AND NAME = 'MIGRATE_BI_PARADA_VISTA' AND SCHEMA_NAME(SCHEMA_ID) = 'GRUPO_9800')
DROP PROCEDURE  GRUPO_9800.MIGRATE_BI_PARADA_VISTA
GO
...
BEGIN
		...
		CREATE TABLE GRUPO_9800.BI_TELEMETRIA_CAJA (
            tele_auto_cod INT ,
		...
		CREATE TABLE GRUPO_9800.BI_TELEMETRIA_MOTOR (
        tele_auto_cod INT ,
		...
		CREATE TABLE GRUPO_9800.BI_TELEMETRIA_NEUMATICO (
			tele_auto_cod INT ,
		...
		CREATE TABLE GRUPO_9800.BI_TELEMETRIA_FRENO (
        tele_auto_cod INT ,
...
AS
BEGIN
		CREATE TABLE GRUPO_9800.BI_DESGASTE_VISTA(
			ID_BI_DESGASTE INT IDENTITY PRIMARY KEY,
			VEHICULO_NUMERO INT REFERENCES GRUPO_9800.BI_TELEMETRIA_AUTO,
			COD_ESCUDERIA INT REFERENCES GRUPO_9800.BI_TELEMETRIA_AUTO,
			CIRCUITO_CODIGO INT REFERENCES GRUPO_9800.BI_TELEMETRIA_AUTO,
			NUMERO_VUELTA INT,
			NRO_SERIE_CAJA NVARCHAR(255) REFERENCES GRUPO_9800.BI_TELEMETRIA_CAJA,
			DESGASTE_CAJA NUMERIC(18,2),
			NRO_SERIE_MOTOR NVARCHAR(255) REFERENCES GRUPO_9800.BI_TELEMETRIA_MOTOR,
			DESGASTE_MOTOR NUMERIC(18,6),
			NRO_SERIE_NEUMATICO NVARCHAR(255) REFERENCES GRUPO_9800.BI_TELEMETRIA_NEUMATICO,
			DESGASTE_NEUMATICO DECIMAL(18,6),
			FRENO_NRO_SERIE NVARCHAR(255) REFERENCES GRUPO_9800.BI_TELEMETRIA_FRENO,
			DESGASTE_FRENO DECIMAL(18,2)
		);

        CREATE TABLE GRUPO_9800.BI_CIRCUITO_VISTA (
        ...
        CREATE TABLE GRUPO_9800.BI_PARADA_VISTA (
            ID_BI_CIRCUITO INT IDENTITY PRIMARY KEY,
        ...
        CREATE TABLE GRUPO_9800.BI_INCIDENTE_VISTA (
...
GO
--BI_TELEMETRIA_CAJA
CREATE PROCEDURE [GRUPO_9800].MIGRAR_BI_telemetria_caja
AS 
BEGIN
	INSERT INTO GRUPO_9800.BI_TELEMETRIA_CAJA
	SELECT * FROM GRUPO_9800.telemetria_caja
END
GO
--BI_TELEMETRIA_MOTOR
CREATE PROCEDURE [GRUPO_9800].MIGRAR_BI_telemetria_motor
AS 
BEGIN
	INSERT INTO GRUPO_9800.BI_TELEMETRIA_MOTOR
	SELECT * FROM GRUPO_9800.telemetria_motor
END
GO
--BI_TELEMETRIA_NEUMATICO
CREATE PROCEDURE [GRUPO_9800].MIGRAR_BI_telemetria_neumatico
AS 
BEGIN
	INSERT INTO GRUPO_9800.BI_TELEMETRIA_NEUMATICO
	SELECT * FROM GRUPO_9800.telemetria_neumatico
END
GO
--BI_TELEMETRIA_FRENO
CREATE PROCEDURE [GRUPO_9800].MIGRAR_BI_telemetria_freno
AS 
BEGIN
	INSERT INTO GRUPO_9800.BI_TELEMETRIA_FRENO
...
GO
CREATE PROCEDURE [GRUPO_9800].MIGRATE_BI_INCIDENTE_VISTA

AS
BEGIN
    INSERT INTO GRUPO_9800.BI_INCIDENTE_VISTA (CIRCUITO_CODIGO,ID_TIPO_SECTOR,COD_ESCUDERIA,CODIGO_INCIDENTE,INCIDENTES_TOTALES_POR_ANIO_POR_ESCUDERIA,COD_TIEMPO)
...
CREATE PROCEDURE [GRUPO_9800].MIGRATE_BI_CIRCUITO_VISTA
AS
BEGIN

	INSERT INTO GRUPO_9800.BI_CIRCUITO_VISTA (COD_ESCUDERIA,CIRCUITO_CODIGO,VEHICULO_NUMERO,MEJOR_TIEMPO_VUELTA,MAXIMO_COMBUSTIBLE_CONSUMIDO,VELOCIDAD,ID_TIPO_SECTOR,COD_TIEMPO)
...
CREATE PROCEDURE [GRUPO_9800].MIGRATE_BI_PARADA_VISTA --LISTO
AS
BEGIN
    INSERT INTO GRUPO_9800.BI_PARADA_VISTA (COD_ESCUDERIA,CIRCUITO_CODIGO,COD_PARADA_BOX,TIEMPO_PARADA_BOX,COD_TIEMPO)
...
--Migracion tabla de hechos desgaste //TODO

/*
CREATE PROCEDURE [GRUPO_9800].MIGRATE_BI_DESGASTE_VISTA
AS
BEGIN
	INSERT INTO GRUPO_9800.BI_DESGASTE_VISTA(VEHICULO_NUMERO,COD_ESCUDERIA,CIRCUITO_CODIGO,NUMERO_VUELTA,
											NRO_SERIE_CAJA,DESGASTE_CAJA,NRO_SERIE_MOTOR,DESGASTE_MOTOR,
											NRO_SERIE_NEUMATICO,DESGASTE_NEUMATICO,FRENO_NRO_SERIE,DESGASTE_FRENO)
	SELECT
	FROM 
	GROUP BY
END
...
EXEC [GRUPO_9800].MIGRAR_BI_telemetria_caja
EXEC [GRUPO_9800].MIGRAR_BI_telemetria_motor
EXEC [GRUPO_9800].MIGRAR_BI_telemetria_neumatico
EXEC [GRUPO_9800].MIGRAR_BI_telemetria_freno
EXEC [GRUPO_9800]._VISTAS

EXEC [GRUPO_9800].MIGRATE_BI_INCIDENTE_VISTA
EXEC [GRUPO_9800].MIGRATE_BI_CIRCUITO_VISTA
EXEC [GRUPO_9800].MIGRATE_BI_PARADA_VISTA
...
DESGASTE PROMEDIO ES LA SUMATORIA DE LOS DESGASTES DE CADA VUELTA DIVIDO LA CANTIDAD DE VUELTAS PARA UN DETERMINADO AUTO Y CIRCUITO*/

/*
CREATE VIEW GRUPO_9800.promedioDesgasteComponentePorAutoPorCircuito
AS
	SELECT
	FROM GRUPO_9800.BI_DESGASTE_VISTA
GO
/*
...
AS
	...
	FROM GRUPO_9800.BI_incidente_VISTA i
...
AS
	...
	FROM GRUPO_9800.BI_parada_VISTA p
...
AS
	...
	FROM GRUPO_9800.BI_parada_VISTA
...
AS
	...
	FROM GRUPO_9800.BI_circuito_vista
...
AS
	...
	FROM GRUPO_9800.BI_circuito_vista cv
